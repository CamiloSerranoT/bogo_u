...
class ModificarTipoFormatPage extends StatefulWidget {
  
  ModificarTipoFormatPage({ Key? key }) : super(key: key);
  final eventoDAO = LugarDAO();

  @override
  ModificarTipoFormatFormPage createState() => ModificarTipoFormatFormPage();
}

class ModificarTipoFormatFormPage extends State<ModificarTipoFormatPage> {
...
class _LugarForm extends StatelessWidget {
  ...
  void _modificarLugar(Tipo tipo) {
    tipoDAO.modificarTodoTipo(tipo.id!,tipo);
  }
