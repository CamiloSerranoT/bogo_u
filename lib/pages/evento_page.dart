...
class _EventoPageBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for(int i = 0; i < eventoService.eventos.length;i++){
      if(eventoService.eventos[i].codigo == evento.codigo){
        evento.id = eventoService.eventos[i].id;
      }
    }
            ...
            Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: IconButton(
                    onPressed: () {
                      Navigator.pushNamed(context, 'modificarimagenevento');
                    },
              ...
              for(int i = 0;i<boletasService.boletas.length;i++){
                if(boletasService.boletas[i].idevento == evento.codigo){
                  if(boletasService.boletas[i].idusuario == usuarioService.usuariosSelect.correo){
                    estado = true;
                    boleta.id = boletasService.boletas[i].id;
                  }
                }
              }

              if(estado == true){
                boletaDAO.eliminarBoleta(boleta.id!);
...
class _EventoForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var vistaListAperSplit = evento.apertura.split(':');
    var vistaListIniSplit = evento.inicio.split(':');
    ...
    var vistaListMinAper = vistaListAperSplit[1];
    var vistaListMinIni = vistaListIniSplit[1];
    ...
    var vistaListHorAper = vistaListAperSplit[0];
    var vistaListHorIni = vistaListIniSplit[0];
  ...
  void _modificarEvento(Evento evento) {
            ...
            children: [
              Padding(
                ...
                child: DropdownButton<String>(
                  ...
                  icon: Icon(Icons.arrow_drop_down,color: Colors.white,),
                  dropdownColor: Colors.grey.withOpacity(0.8),
                  items: listaDesplegableHor.map<DropdownMenuItem<String>>((String value14){
                    return DropdownMenuItem<String>( 
                      alignment: Alignment.center,
                      value: value14,
                      child: Text(
            ...
            children: [
              Padding(
                ...
                child: DropdownButton<String>(
                  ...
                  icon: Icon(Icons.arrow_drop_down,color: Colors.white,),
                  dropdownColor: Colors.grey.withOpacity(0.8),
                  items: listaDesplegableHor.map<DropdownMenuItem<String>>((String value15){
                    return DropdownMenuItem<String>( 
                      alignment: Alignment.center,
                      value: value15,
                      child: Text(
